...
local keymap = {
    ...
    { "<leader><Up>",   "<cmd>res +3<CR>",                           mode = mode_n,   desc = "resize window up" }, -- 窗口操作
    { "<leader><Down>", "<cmd>res -3<CR>",                           mode = mode_n,   desc = "resize window down" },
    { "<leader><Left>", "<cmd>vertical resize -3<CR>",               mode = mode_n,   desc = "resize window left" },
    { "<leader><Right>","<cmd>vertical resize +3<CR>",               mode = mode_n,   desc = "resize window right" },
